...
<html ng-app="myApp">
    ...
    <body ng-controller="fController">
         <div treecontrol="" class="col-lg-2 tree-classic" tree-model="collectionTreeData" on-selection="showSelected(node)" selected-node="selectedCollection" options="treeOptions">
            {{node.name}}
        </div>
        <div class="col-lg-6">
    ...
    <script text="text/javascript">
        app.controller("fController", function($scope, $http, usSpinnerService) {
            ...
            $http.get("/ThuisAdmin/json/collections/hoofdCollections").success( function(data){
                  $scope.collectionTreeData = data;
              });
            $http.get("/ThuisAdmin/json/collections/select/<c:out value="${collectionId}"/>").success( function(data){
