...
public class InvoicesSrvPojo implements Invoices{
    ...
    public InvoicesSrvPojo(){}
    public InvoicesSrvPojo(Invoices invoices){
        ...
        this.rekening = invoices.getRekening() != null ? new RekeningenSrvPojo(invoices.getRekening()) : null;
