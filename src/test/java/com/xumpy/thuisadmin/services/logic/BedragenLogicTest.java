...
public class BedragenLogicTest{
    ...
    @Mock BedragenDaoPojo bedragMock;
    @Mock GroepenDaoPojo groepMock;
    
    @Mock BedragenDaoPojo oldBedragMock;
    @Mock GroepenDaoPojo oldGroepMock;
    
    @Mock BedragenDaoImpl bedragenDao;
    @Mock RekeningenDaoImpl rekeningenDao;
    
    @InjectMocks BedragenLogic bedragenLogic;
    RekeningenDaoPojo rekening;
    
    @Before
    public void setUp2(){
        rekening = new RekeningenDaoPojo();
        ...
        when(bedragenDao.findBedrag(1)).thenReturn(oldBedragMock);
    }
